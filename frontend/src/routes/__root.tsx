...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LeadFunnel · GTM Hackathon" },
      { name: "description", content: "Automatización de búsqueda y validación de leads B2B con scraping multifuente, validación RUES y scoring." },
    ],
